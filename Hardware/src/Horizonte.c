...
// clang-format off
// src/Horizonte.c generated from src/Horizonte.gatt for BTstack
// it needs to be regenerated when the .gatt file is updated. 

// To generate src/Horizonte.c:
// C:\Users\manue\pico-sdk\lib\btstack\tool\compile_gatt.py src/Horizonte.gatt src/Horizonte.c
...
const uint8_t profile_data[] =
{
    ...
    // horizonte.gatt
    //
    // Definición del perfil GATT para el proyecto Horizonte.
    // Contiene los permisos de escritura correctos (BIT_0) para
    // solucionar el error "GATT WRITE NOT PERMIT".
    // Servicio FFE0
    ...
    // Característica FFE2
    // Propiedades: Read, Write, Notify, Write Without Response
    // Permisos: CUALQUIERA (BIT_0) puede leer y escribir
